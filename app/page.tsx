        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Help your agile team estimate story points with our interactive planning poker tool.
              Create sessions, invite team members, and reach consensus faster.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Everything you need for effective story point estimation
            </p>
          </div>
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                <CardDescription>
                  Choose from Fibonacci, T-shirt sizes, or custom card sets that fit your team's
                  needs
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <CardDescription>
                  Full session control with options to reveal cards, clear estimates, and manage
                  participants
                </CardDescription>
              </CardContent>
            </Card>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div className="text-center">
              ...
              <p className="mt-2 text-gray-600">
                Everyone selects their cards, then reveal them together to see the results and
                statistics
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <p className="mt-4 text-xl text-red-100">
              Create your first planning poker session now
            </p>
            <div className="mt-8">
              <Link href="/create">
                <Button
